...
class AttestationFormatTest {
    ...
    var result =
        rp.finishRegistration(
            FinishRegistrationOptions.builder()
                ...
                .response(
                    jsonMapper
                        .readValue(credential.toJson(), CredentialCreationResponse.class)
                        .credential())
                .build());
  ...
  void testFidoU2FAttestation_OnlySupportsES256() throws Exception {
    ...
    var emulator =
        Yubikey.get5cNfc().toBuilder()
            ...
            .supportedAlgorithms(
                List.of(COSEAlgorithmIdentifier.ES256, COSEAlgorithmIdentifier.ES384))
            .build();
  ...
  void testNoneAttestation() throws Exception {
    var emulator = Yubikey.get5cNfc().toBuilder().attestationFormat(AttestationFormat.NONE).build();
  ...
  void testAttestationAlgorithmConfiguration() throws Exception {
    ...
    var emulator =
        YubiKeyEmulator.builder()
            ...
            .supportedAlgorithms(
                List.of(COSEAlgorithmIdentifier.ES256)) // But only ES256 for credentials
            .supportedAttachmentTypes(
                List.of(dev.ethantmcgee.yubiauthn.model.AuthenticatorAttachmentType.CROSS_PLATFORM))
