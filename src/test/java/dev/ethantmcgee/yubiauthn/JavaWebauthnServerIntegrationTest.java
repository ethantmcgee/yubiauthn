...
public class JavaWebauthnServerIntegrationTest {
  ...
  @Test
  void testYubiKey5CiFidoU2fAttestation() throws Exception {
    final var emulator = Yubikey.get5Ci();
  ...
  @Test
  void testSecurityKeyFidoU2fAttestation() throws Exception {
    final var emulator = Yubikey.getSecurityKey();
  ...
  @Test
  void testYubiKeyBioSeriesPackedAttestation() throws Exception {
    final var emulator = Yubikey.getBioSeries();
