 ...
 * or emulator. It contains the credential ID, key pair, algorithm, and related metadata needed
 * for authentication operations.
 *
 * <p>This is not directly specified in the WebAuthn specification but represents the internal
 * state that an authenticator maintains for each credential.
 */
