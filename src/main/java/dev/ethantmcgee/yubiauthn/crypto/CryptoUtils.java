...
public class CryptoUtils {
     ...
     */
    public static KeyPair generateKeyPair(COSEAlgorithmIdentifier algorithm) throws NoSuchAlgorithmException, InvalidAlgorithmParameterException {
    ...
    private static KeyPair generateECKeyPair(String curveName) throws NoSuchAlgorithmException, InvalidAlgorithmParameterException {
    ...
    private static KeyPair generateEdDSAKeyPair() throws NoSuchAlgorithmException, InvalidAlgorithmParameterException {
     ...
     */
    public static byte[] encodeCOSEPublicKey(PublicKey publicKey, COSEAlgorithmIdentifier algorithm) throws IOException {
    ...
    /**
     * Simple CBOR encoding for COSE key map.
     * This is a simplified implementation for the specific structure needed.
     */
    ...
    private static void encodeCBORByteString(ByteArrayOutputStream baos, byte[] bytes) throws IOException {
        if (bytes.length < 24) {
    ...
    /**
     * Signs data using the specified algorithm and private key.
     */
    public static byte[] sign(byte[] data, PrivateKey privateKey, COSEAlgorithmIdentifier algorithm) throws Exception {
    ...
    /**
     * Generates an attestation certificate for the authenticator.
     */
    public static X509Certificate generateAttestationCertificate(KeyPair keyPair, String subject) throws Exception {
     ...
     */
    public static byte[] createAttestedCredentialData(byte[] aaguid, byte[] credentialId, byte[] credentialPublicKey) {
